...
<div>
<a href="https://arxiv.org/abs/2204.01918">[arXiv paper]</a>
<a href="https://openaccess.thecvf.com/content/CVPR2022/papers/Zhang_Text_Spotting_Transformers_CVPR_2022_paper.pdf">[CVPR paper]</a>
</div>

## Description

This is an implementation of [TESTR](https://github.com/mlpc-ucsd/TESTR) based on [MMOCR](https://github.com/open-mmlab/mmocr/tree/dev-1.x), [MMCV](https://github.com/open-mmlab/mmcv), and [MMEngine](https://github.com/open-mmlab/mmengine).
...
All the commands below rely on the correct configuration of `PYTHONPATH`, which should point to the project's directory so that Python can locate the module files. In `TESTR/` root directory, run the following line to add the current directory to `PYTHONPATH`:
...
if the data is not in `TESTR/`, you can link the data into `TESTR/`:
